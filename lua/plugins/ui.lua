return {
  {
    ...
    opts = {
      override = {
        default_icon = { icon = require("kwaylenvim.utils").get_icon "DefaultFile" },
        deb = { icon = "", name = "Deb" },
  ...
  },
  {
    ...
    lazy = true,
    init = function() require("kwaylenvim.utils").load_plugin_with_func("nvim-notify", vim, "notify") end,
    opts = {
  ...
  },
  {
    ...
    lazy = true,
    init = function() require("kwaylenvim.utils").load_plugin_with_func("dressing.nvim", vim.ui, { "input", "select" }) end,
    opts = {
