--- ### kwaylenvim Buffer Utilities
--
-- Buffer management related utility functions
--
-- This module can be loaded with `local buffer_utils = require "kwaylenvim.utils.buffer"`
--
-- @module kwaylenvim.utils.buffer
-- @copyright 2022
...
---@param compare_func string|function a string of a comparator defined in require("kwaylenvim.utils.buffer").comparator or a custom comparator function
...
local function unique_path(bufnr)
  return require("kwaylenvim.utils.status.provider").unique_path() { bufnr = bufnr }
