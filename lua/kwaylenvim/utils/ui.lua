--- ### kwaylenvim UI Options
--
--  Utility functions for easy UI toggles.
--
-- This module can be loaded with `local ui = require("kwaylenvim.utils.ui")`
--
-- @module kwaylenvim.utils.ui
...
local function ui_notify(silent, ...) return not silent and require("kwaylenvim.utils").notify(...) end

--- Toggle notifications for UI toggles
---@param silent? boolean if true then don't sent a notification
function M.toggle_ui_notifications(silent) -- TODO: rename to toggle_notifications in kwaylenvim v4
...
function M.toggle_diagnostics(silent)
  ...
  vim.diagnostic.config(require("kwaylenvim.utils.lsp").diagnostics[vim.g.diagnostics_mode])
...
-- TODO: remove old function name in kwaylenvim v4
...
function M.toggle_url_match(silent)
  ...
  require("kwaylenvim.utils").set_url_match()
