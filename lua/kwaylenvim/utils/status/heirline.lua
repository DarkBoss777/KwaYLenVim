--- ### kwaylenvim Status Heirline Extensions
--
-- Statusline related heirline specific extensions
--
-- This module can be loaded with `local astro_heirline = require "kwaylenvim.utils.status.heirline"`
--
-- @module kwaylenvim.utils.status.heirline
-- @copyright 2023
...
M.make_buflist = function(component)
  ...
  return require("heirline.utils").make_buflist(
    ...
    function() return vim.t.bufs or {} end, -- use kwaylenvim bufs variable
