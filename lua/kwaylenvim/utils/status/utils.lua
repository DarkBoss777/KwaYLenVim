--- ### kwaylenvim Status Utilities
--
-- Statusline related uitility functions
--
-- This module can be loaded with `local status_utils = require "kwaylenvim.utils.status.utils"`
--
-- @module kwaylenvim.utils.status.utils
-- @copyright 2023
...
-- @usage local string = require("kwaylenvim.utils.status").utils.stylize("Hello", { padding = { left = 1, right = 1 }, icon = { kind = "String" } })
...
-- @usage local heirline_component = { on_click = { callback = function(...) local args = require("kwaylenvim.utils.status").utils.statuscolumn_clickargs(...) end } }
