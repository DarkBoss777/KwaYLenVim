--- ### kwaylenvim Status Environment
--
-- Statusline related environment variables shared between components/providers/etc.
--
-- This module can be loaded with `local env = require "kwaylenvim.utils.status.env"`
--
-- @module kwaylenvim.utils.status.env
-- @copyright 2023
...
M.separators = kwaylenvim.user_opts("heirline.separators", {
  none = { "", "" },
  left = { "", "  " },
  right = { "  ", "" },
  center = { "  ", "  " },
...
M.attributes = kwaylenvim.user_opts("heirline.attributes", {
...
M.icon_highlights = kwaylenvim.user_opts("heirline.icon_highlights", {
  file_icon = {
...
M.sign_handlers = kwaylenvim.user_opts("heirline.sign_handlers", M.sign_handlers)
