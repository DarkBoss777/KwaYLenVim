...
local options = kwaylenvim.user_opts("options", {
  opt = {
  ...
  g = {
    ...
    -- kwaylenvim specific global options
    ...
    ui_notifications_enabled = true, -- disable notifications (TODO: rename to  notifications_enabled in kwaylenvim v4)
